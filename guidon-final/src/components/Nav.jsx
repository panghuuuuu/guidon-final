  ...
  return (
    <section id="nav">
      <nav className="nav-bar">
        <h6
          className={
            isMobile & (activeIcon === "close") ? "show-browse" : "hide-browse"
          }
        >
          Browse Categories
        </h6>
        <ul
          className={
            isMobile & (activeIcon === "close") ? "mobile-list" : "desktop-list"
          }
        >
          <li>News</li>
          <li>Opinion</li>
      ...
      <hr
        className={
          isMobile & (activeIcon === "close") ? "show-line" : "hide-line"
        }
      />
      <form
        className={
          isMobile & (activeIcon === "close") ? "subscribe-form" : "hide-form"
        }
      >
